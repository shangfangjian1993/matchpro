...
# CANONICAL_NAMES export for backward compatibility
# Maps normalized lowercase team name -> canonical official name
CANONICAL_NAMES: dict[str, str] = {}
for _k, _v in list(globals().items()):
    if isinstance(_v, str) and _k.isupper() and not _k.startswith('_'):
        _normalized = _k.lower().replace('_', ' ')
        CANONICAL_NAMES[_normalized] = _v

# Build from explicit known variations
_EXTRA_NAMES = {
    "man city": "Manchester City",
    "man united": "Manchester United",
...
CANONICAL_NAMES.update(_EXTRA_NAMES)
