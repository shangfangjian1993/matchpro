...
class PredictionEngine:
 ...
 # ══ :Goal/Ensemble 核心 —— 失败直接 raise,不静默降级 ══
 try:
 ...
 # Uncertainty(基于成员概率与特征质量;FEATURE_IMPACT 不可用不降级)
