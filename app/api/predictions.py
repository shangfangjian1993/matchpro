...
def predict_match_endpoint(body: PredictMatchReq, user=Depends(get_current_user)):
    ...
    pred = Prediction(
        ...
        home_goals_prediction=result["raw_lambda_home"],
        away_goals_prediction=result["raw_lambda_away"],
...
def _snap_dict(s) -> dict:
    return {
        ...
        "raw_lambda_home": getattr(s, "home_goals_prediction", None),
        "raw_lambda_away": getattr(s, "away_goals_prediction", None),
