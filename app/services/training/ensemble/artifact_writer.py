...
def write_all(weights, params, meta, artifacts_dir: str) -> None:
    ...
    with open(os.path.join(artifacts_dir, "ensemble_weights.json"), "w", encoding="utf-8") as f:
        json.dump(weights, f, ensure_ascii=False, indent=2)
    with open(os.path.join(artifacts_dir, "dc_nb_params.json"), "w", encoding="utf-8") as f:
